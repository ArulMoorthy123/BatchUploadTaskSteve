...
@Component({
  selector: 'app-profile-education-details',
  templateUrl: './profile-education-details.component.html'
})
export class ProfileEducationDetailsComponent implements OnInit {
