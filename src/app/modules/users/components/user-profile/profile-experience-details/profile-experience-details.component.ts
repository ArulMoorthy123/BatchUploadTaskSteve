...
@Component({
  selector: 'app-profile-experience-details',
  templateUrl: './profile-experience-details.component.html'
})
export class ProfileExperienceDetailsComponent implements OnInit {
